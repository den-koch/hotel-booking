...
import io.github.denkoch.hotel_booking_spring.graphql.dto.RoomIdInput;
...
public interface RoomRepository extends CrudRepository<Room, RoomId>, JpaSpecificationExecutor<Room> {
